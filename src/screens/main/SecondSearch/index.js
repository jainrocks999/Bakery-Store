  ...
  const searchFilterFunction = async text => {
    ...
    try {
      ...
      const response = await axios({
        ...
        url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiproduct/search',
      });
    ...
    if (customer_id) {
      ...
      try {
        ...
        const response = await axios({
          ...
          url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiproduct/productDetails',
        });
  ...
  const addWish = async id => {
    ...
    try {
      ...
      const response = await axios({
        ...
        url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiproduct/add_wishlist',
      });
      if (response.data.status == true) {
        setFetching(false);
        try {
                    ...
                    <View style={{ width: '56%', marginTop: 20 }}>
                      <View
                        ...
                        {item.p_type == 1 ? (
                          ...
                          <View
                            style={[styles.view1, { borderColor: '#f68b1f' }]}>
                            <View
                              style={[
                                styles.border,
                                { backgroundColor: '#f68b1f' },
