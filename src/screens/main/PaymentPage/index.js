  ...
  const firstCall = async () => {
    ...
    try {
      ...
      const response = await axios({
        ...
        url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiorder2/cart',
      });
  ...
  const ApplyCoupon = async (coupn, val) => {
    ...
    try {
      ...
      const response = await axios({
        ...
        url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiorder/applyCoupon',
      });
      ...
      //     var location = json.results[0].geometry.location;
          if ( store_id) {
            try {
              ...
              data1.append('latitude','22.722368263929663');
              data1.append('longitude','75.85388984018974' );
              const response = await axios({
                method: 'POST',
                data: data1,
                headers: {
                ...
                url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiorder/dunzo',
              });
              ...
              if (response.data.isDunzoActive) {
                if (response.data.status) {
                  navigation.navigate('Quick', {
                    data: data,
                    dunzo: response.data,
                    lat: '22.722368263929663',
                    long: '75.85388984018974',
                          ...
                          <View style={[styles.row, { width: '75.5%' }]}>
                            <View
                              ...
                              {item.p_type == 1 ? (
                                ...
                                <View
                                  style={[styles.sq, { borderColor: '#f68b1f' }]}>
                                  <View
                                    style={[
                                      styles.dot,
