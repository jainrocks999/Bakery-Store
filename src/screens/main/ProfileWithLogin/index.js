            ...
            {customer_id ? (
              <View style={styles.view}>
                <View style={{ width: '75%' }}>
                  ...
                  <TouchableOpacity
                  style={{borderBottomWidth:1,alignSelf:'flex-start',borderColor:'#f68b1f'}}
                   onPress={() => { disableAccount() }}>
                    <Text style={{ marginTop: 10, color: '#f68b1f',  fontFamily: 'Montserrat-Medium', }}>Delete Account</Text>
                    {/* <View style={{ borderBottomWidth: 1, width: 115, borderColor: 'red' }} /> */}
                  </TouchableOpacity>
                </View>
                <TouchableOpacity
                  ...
                  /> */}
                   <Image style={{height: 60, width: 80}} source={require('../../../assets/Logo/baker.png')}/>
                </TouchableOpacity>
              </View>
            ) : null}
            {customer_id ? (
