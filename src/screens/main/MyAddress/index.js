        ...
        const address_id = await AsyncStorage.getItem("Address_id")
           try {
            ...
            const response = await axios({
              ...
              url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiorder/addressDelete',
            });
    ...
    const editAddress=async(item)=>{
        ...
        try {
            ...
            const response = await axios({
              ...
              url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiorder/addressById',
            });
            if (response.data.status == true) {
              setFetching(false)
