...
const CategoryList = () => {
  ...
  const removeWishList = async id => {
    ...
    try {
      ...
      const response = await axios({
        ...
        url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiproduct/delete_wishlist',
      });
      if (response.data.status == true) {
  ...
  console.log('this is filter filteredDataSource',filteredDataSource);
  return (
