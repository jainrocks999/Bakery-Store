   ...
   const manageReOrder=async(order_id)=>{
    ...
    try {
        ...
        const response = await axios({
            ...
            url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiorder/reOrder',
        });
                                            ...
                                            <View style={[styles.cont, { marginTop: 12 }]}>
                                                <View style={styles.view1}>
                                                   {item.p_type==1? <View
                                                    ...
                                                    <View
                                                    style={[styles.view,{ borderColor:'#f68b1f',}]}>
                                                    <View style={[styles.square,{backgroundColor: '#f68b1f',}]} />
                                                     </View>
                                                    }
