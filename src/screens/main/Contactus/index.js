           ...
           Toast.show('Please enter phone number')
            ...
            try {
                ...
                const response = await axios({
                  ...
                  url:`https://craftsweb.co.in/food-delivery/upload/index.php?route=api/contactus/contactForm&name=${name}&email=${email}&phoneNumber=${mobile}&topic=${first=='---Please Select---'?'':first}&message=${message}`,
                });
    ...
    const getStoreDetails=async(id)=>{
        ...
        try {
            ...
            const response = await axios({
              ...
              url:`https://craftsweb.co.in/food-delivery/upload/index.php?route=api/contactus/storeAddress&store_id=${id}`,
            });
            console.log('this is respose',response.data);
            if (response.data.status == true) {
                ...
                <View>
                        ...
                        <View>
                            ...
                            <View style={{ marginTop: 10 }}>
                                <Text style={styles.heading}>{'Your Name'}
                                   <Text style={{color:'#f68b1f',fontSize:16}}>*</Text>
                                </Text>
                            ...
                            <View style={{ marginTop: 10 }}>
                                ...
                                <Text style={{color:'#f68b1f',fontSize:16}}>*</Text></Text>
                                <View style={styles.view}>
                                    <TextInput
                                        style={styles.input}
                            ...
                            <View style={{ marginTop: 10 }}>
                                ...
                                <TouchableOpacity
                                    ...
                                    style={[styles.touch, { borderWidth: 2, borderColor: '#f68b1f', }]}>
                                    <TextInput
                                        ref={inputRef}
                                        placeholderTextColor={'#000000'}
                                        style={styles.input}
                            ...
                            <View style={styles.space}>
                                <CheckBox
                                    ...
                                    tintColors={{ true: '#f68b1f', false: 'grey' }}
                                    onTintColor='#f68b1f'
                                    onCheckColor='#f68b1f'
                                    boxType='square'
                    ...
                    openDuration={250}>
                        <View style={{padding:15}}>
                            ...
                            <TouchableOpacity onPress={()=> refRBSheet.current.close()} style={{ backgroundColor: '#f68b1f',paddingHorizontal:10,paddingVertical:4,borderRadius:6,alignItems:'center',justifyContent:'center'}}>
