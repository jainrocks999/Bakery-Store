      ...
      if (toggleCheckBox1 == false) {
        ...
        try {
          ...
          const response = await axios({
            ...
            url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/neworder/addOrder',
          });
          if (response.data.status == true) {
            try {
              ...
              const responsedata1 = await axios({
                ...
                url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiorder/addInstruction',
              });
              ...
              if (responsedata1.data.status == true) {
                try {
                  ...
                  const responsedata = await axios({
                    ...
                    url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/checkout/payment',
                  });
  ...
  const firstCall = async msg => {
    ...
    try {
      ...
      const response = await axios({
        ...
        url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiorder/cart',
      });
    ...
    if (item.quantity) {
      ...
      try {
        ...
        const response = await axios({
          ...
          url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiorder/update_to_cart',
        });
                            ...
                            <View style={styles.border}>
                              ...
                              <View style={{ alignItems: 'center' }}>
                                <View style={styles.cont}>
                                  ...
                                  />
                                  {/* <Text style={{ fontSize: 11, color: '#f68b1f' }}>{item.quantity}</Text> */}
                                  <TouchableOpacity
                                    style={styles.uri}
                  ...
                  <View>
                    ...
                    <View style={[styles.view, { marginTop: 10 }]}>
                      ...
                      <Text
                        ...
                        I wish to subscribe to the Bakery Store Confectioners Pvt.
                        Ltd. newsletter.
                      </Text>
                    </View>
