...
const HomeScreen = ({ route }) => {
  ...
  const dataa = async () => {
    ...
    // setVisible(data==null?true:false)
    setState(data);
    setLocation(data);
    dispatch({
    ...
    try {
      ...
      const response = await axios({
        ...
        url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/origin/login',
      });
          ...
          if (selector[index].store_id == store_id) {
            ...
            try {
              ...
              const response = await axios({
                ...
                url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/cart/clearcart',
              });
            } catch (error) {
              throw error;
            }
        ...
        {selector1?.specialProduct == true ? (
          <ImageBackground
            ...
            <View style={styles.specialView}>
              <Text style={styles.merwans}>Bakery Store Special</Text>
            </View>
        ...
        <View style={styles.pop}>
          <View style={styles.popView}>
            <Text style={styles.welcome}>
              {'WELCOME TO Bakery Store CONFECTIONERS PVT. LTD.'}
            </Text>
          </View>
