    ...
    const validateUser = async (values) => {
        ...
        if(address1==''){
            ...
            try {
                ...
                data.append('company', 'Bakery Store');
                ...
                const response = await axios({
                    ...
                    url: 'https://craftsweb.co.in/food-delivery/upload/index.php?route=api/apiorder/addressUpdate',
                });
                ...
                if (response.data.status == true) {
                    ...
                    dispatch({
                        ...
                        url: 'apiorder/addlatlong',
                        address_id: response.data.address_id,
                        lat: '22.72458498191231',
                        long:'75.84942664450568',
                    });
                    dispatch({
