        ...
        <View style={{flex:1}}>
            <ImageBackground style={{padding:8}} source={require('../../../assets/Icon/bg.png')}>
               ...
               style={{
                   ...
                   fontSize:20,
                   marginTop:10
                   }}>Bakery Store Interactive Assistant</Text>
                   <View style={{
                     ...
                     <Text style={{color:'#000000',fontFamily:'Montserrat-SemiBold',fontSize:16}}>Bakery Store</Text>
                     <Text 
                     style={{
                         marginTop:6,
                       ...
                       renderItem={({item})=>(
                           <View style={{marginTop:10}}>
                               ...
                               <Text style={{
                                   ...
                                   fontFamily:'Montserrat-Medium',
                                   fontSize:10
                                   }}>Bakery Store Bakers,Andheri West</Text>
                               <Text 
                               style={{
                                   color:'#000000',
...
const data=[
    {address:'Bakery Store Bakers,Andheri West',desc:'Place on 23 oct 2022 at 7pm 1pc Black Forest cake and etc.'},
    {address:'Bakery Store Bakers,Andheri West',desc:'Place on 23 oct 2022 at 7pm 1pc Black Forest cake and etc.'},
    {address:'Bakery Store Bakers,Andheri West',desc:'Place on 23 oct 2022 at 7pm 1pc Black Forest cake and etc.'}
